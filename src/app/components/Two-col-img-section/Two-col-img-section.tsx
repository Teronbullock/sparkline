...
const TwoColImgSection = ({
    ...
    return (
        <section className={`sl-section ${classes}`}>
            <Columns
                colsClasses={`container mx-auto lg:flex-row items-center px-12 ${colsClasses}`}
            >
                <Column>{leftColContent}</Column>
                <Column>{rightColContent}</Column>
            </Columns>
        </section>
    );
};
